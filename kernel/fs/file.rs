...
pub use bindings::file as linux_file;

#[allow(unused_imports)]
pub use bindings::inode;

#[allow(unused_imports)]
pub use bindings::file_operations as file_ops;

#[allow(unused_imports)]
pub use bindings::alloc_chrdev_region;


#[allow(unused_imports)]
pub use bindings::class_create;

#[allow(unused_imports)]
pub use bindings::device_create;


#[allow(unused_imports)]
pub use bindings::dev_t;


#[allow(unused_imports)]
pub use bindings::class;

#[allow(unused_imports)]
pub use bindings::cdev_init;

#[allow(unused_imports)]
pub use bindings::cdev_add;

#[allow(unused_imports)]
pub use bindings::cdev;


#[allow(missing_docs)]
#[allow(unused_imports)]
#[cfg(MODULE)]
pub static THIS_MODULE: kernel::ThisModule = unsafe {
    {
        kernel::ThisModule::from_ptr(
            core::ptr::addr_of!(kernel::bindings::__this_module) as *const kernel::bindings::module
                as *mut kernel::bindings::module,
        )
    }
};
...
//#[allow(missing_docs)]
//#[allow(unused_imports)]
//pub static THIS_MODULE_C: kernel::bindings::module = unsafe { kernel::bindings::__this_module };
